...
mixin _$RadioState {
 ...
 List<RadioStation> get stations; String get query; Set<String> get favoriteIds; bool get isLoading;/// `true` enquanto mostra lista salva (Fase 27) e busca de novo por
/// trás.
 bool get isRevalidating; String? get error; bool get offline; String? get nowPlayingId; RadioStation? get nowPlaying; bool get isPlaying; bool get isBuffering;
...
int get hashCode {
  final _this = this as RadioState;
  return Object.hash(runtimeType,const DeepCollectionEquality().hash(_this.stations),_this.query,const DeepCollectionEquality().hash(_this.favoriteIds),_this.isLoading,_this.isRevalidating,_this.error,_this.offline,_this.nowPlayingId,_this.nowPlaying,_this.isPlaying,_this.isBuffering);
}

@override
String toString() {
  final _this = this as RadioState;
  return 'RadioState(stations: ${_this.stations}, query: ${_this.query}, favoriteIds: ${_this.favoriteIds}, isLoading: ${_this.isLoading}, isRevalidating: ${_this.isRevalidating}, error: ${_this.error}, offline: ${_this.offline}, nowPlayingId: ${_this.nowPlayingId}, nowPlaying: ${_this.nowPlaying}, isPlaying: ${_this.isPlaying}, isBuffering: ${_this.isBuffering})';
}
...
@useResult
$Res call({
 List<RadioStation> stations, String query, Set<String> favoriteIds, bool isLoading, bool isRevalidating, String? error, bool offline, String? nowPlayingId, RadioStation? nowPlaying, bool isPlaying, bool isBuffering
});
...
/// Create a copy of RadioState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? stations = null,Object? query = null,Object? favoriteIds = null,Object? isLoading = null,Object? isRevalidating = null,Object? error = freezed,Object? offline = null,Object? nowPlayingId = freezed,Object? nowPlaying = freezed,Object? isPlaying = null,Object? isBuffering = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<RadioStation> stations,  String query,  Set<String> favoriteIds,  bool isLoading,  bool isRevalidating,  String? error,  bool offline,  String? nowPlayingId,  RadioStation? nowPlaying,  bool isPlaying,  bool isBuffering)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RadioState() when $default != null:
return $default(_that.stations,_that.query,_that.favoriteIds,_that.isLoading,_that.isRevalidating,_that.error,_that.offline,_that.nowPlayingId,_that.nowPlaying,_that.isPlaying,_that.isBuffering);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<RadioStation> stations,  String query,  Set<String> favoriteIds,  bool isLoading,  bool isRevalidating,  String? error,  bool offline,  String? nowPlayingId,  RadioStation? nowPlaying,  bool isPlaying,  bool isBuffering)  $default,) {final _that = this;
switch (_that) {
case _RadioState():
return $default(_that.stations,_that.query,_that.favoriteIds,_that.isLoading,_that.isRevalidating,_that.error,_that.offline,_that.nowPlayingId,_that.nowPlaying,_that.isPlaying,_that.isBuffering);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<RadioStation> stations,  String query,  Set<String> favoriteIds,  bool isLoading,  bool isRevalidating,  String? error,  bool offline,  String? nowPlayingId,  RadioStation? nowPlaying,  bool isPlaying,  bool isBuffering)?  $default,) {final _that = this;
switch (_that) {
case _RadioState() when $default != null:
return $default(_that.stations,_that.query,_that.favoriteIds,_that.isLoading,_that.isRevalidating,_that.error,_that.offline,_that.nowPlayingId,_that.nowPlaying,_that.isPlaying,_that.isBuffering);case _:
  return null;
...
class _RadioState implements RadioState {
  const _RadioState({ List<RadioStation> stations = const <RadioStation>[], this.query = '',  Set<String> favoriteIds = const <String>{}, this.isLoading = false, this.isRevalidating = false, this.error, this.offline = false, this.nowPlayingId, this.nowPlaying, this.isPlaying = false, this.isBuffering = false}): _stations = stations,_favoriteIds = favoriteIds;
...
/// trás.
@override@JsonKey() final  bool isRevalidating;
...
@override
int get hashCode {
    return Object.hash(runtimeType,const DeepCollectionEquality().hash(_stations),query,const DeepCollectionEquality().hash(_favoriteIds),isLoading,isRevalidating,error,offline,nowPlayingId,nowPlaying,isPlaying,isBuffering);
}

@override
String toString() {
    return 'RadioState(stations: $stations, query: $query, favoriteIds: $favoriteIds, isLoading: $isLoading, isRevalidating: $isRevalidating, error: $error, offline: $offline, nowPlayingId: $nowPlayingId, nowPlaying: $nowPlaying, isPlaying: $isPlaying, isBuffering: $isBuffering)';
}
...
/// Create a copy of RadioState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? stations = null,Object? query = null,Object? favoriteIds = null,Object? isLoading = null,Object? isRevalidating = null,Object? error = freezed,Object? offline = null,Object? nowPlayingId = freezed,Object? nowPlaying = freezed,Object? isPlaying = null,Object? isBuffering = null,}) {
